...
WORDS_CHOOSE_FORMAT = (
    "Как тренируемся? \n\n"
    "В наборе 10 слов.\n\n"
    "Варианты ответа — выбираешь перевод из вариантов (режим изучения).\n\n"
    "Самопроверка — я даю слова, ты говоришь перевод вслух. Через 5 секунд я покажу правильный ответ. Писать в чат не нужно."
)
BTN_FORMAT = {
