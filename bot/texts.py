...
ONBOARDING_DONE = (
    ...
    "Полезное:\n"
    "«Настройки» или /settings — стиль, напоминания, уровень\n"
    "«Мой прогресс» или /progress\n"
    "«Премиум» или /premium\n"
    "«Справка» или /help"
)
...
WELCOME_BACK = (
    ...
    "Пиши по-английски или нажми «Чем займемся?».\n"
    "Настройки: «Настройки» или /settings"
)
...
HELP = (
    ...
    "Настройки и сервис (можно словами или через /):\n"
    "• «Настройки» или /settings — профиль и напоминания\n"
    "• «Поменять стиль объяснения» или /style\n"
    "• «Напоминания» или /reminders\n"
    "• «Мой прогресс» или /progress\n"
    "• «Премиум» или /premium\n"
    "• «Обратная связь» или /feedback\n"
    "• «Справка» или /help\n\n"
    "/start — если ты здесь впервые (онбординг)"
)

# Русские текстовые команды (без слэша)
CMD_SETTINGS = "Настройки"
CMD_STYLE = "Поменять стиль объяснения"
...
BTN_SETTINGS_STYLE = "Поменять стиль объяснения"
...
FEEDBACK_ASK = (
    ...
    "я передам это разработчику. Можно одним сообщением."
)
FEEDBACK_THANKS = "Спасибо! Твой отзыв сохранён."

# --- Прогресс ---
PROGRESS = (
    "🔥 Серия: {streak_days} {streak_label}\n"
...
REMINDER_STREAK = (
    "🔥 Не теряй серию из {streak} дней! "
    "Пара минут практики — и streak сохранится."
)
